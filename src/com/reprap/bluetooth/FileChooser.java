...
public class FileChooser {
    ...
    static class FileSelectView extends ListView implements OnItemClickListener{  
        ...
        {  
            ...
            SimpleAdapter adapter = new SimpleAdapter(getContext(), list, R.layout.file_chooser, new String[]{"img", "name", "path"}, new int[]{R.id.filedialogitem_img, R.id.filedialogitem_name, R.id.filedialogitem_path});  
